...
public class UserHttpClient : IUserService
{
    ...
    public async Task<User> Create(UserCreationDTO dto)
    {
        ...
        /*
         * At the end of the call, line 13, there is a null-suppressor: "!", i.e. the exclamation mark.
         * This is because, the Deserialize method returns a nullable object, i.e. User?,
